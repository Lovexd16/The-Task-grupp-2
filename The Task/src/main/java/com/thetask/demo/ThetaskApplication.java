...
public class ThetaskApplication {
	...
	public static void main(String[] args) {
		...
		ListOfToDos.removeToDo("Balle", "Träna", "Axlar", 1000);
		// System.out.println("är detta axlar? "
		// +
		// userlist.getUserList().get(1).getToDoLists().get(1).getListOfToDos().get(0).getName());
