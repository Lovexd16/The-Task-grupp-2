...
public class ThetaskApplication {
	...
	public static void main(String[] args) {
		...
		// System.out.println("namnen på Kalles listor " +
		// user.getToDoLists().get(0).getNameOfList() + " "
		...
		// System.out.println("Balles innehåll i listan innan borttagning av axlar i
		// listan träna");
		...
		// System.out.println("Balles innehåll i listan efter borttagning av axlar i
		// listan träna");
		// for (User user : ThetaskApplication.userlist.getUserList()) {
		// if (user.getUsername().equals("Balle")) {
		// for (ListOfToDos list : user.getToDoLists()) {
		...
		// removeListForUser("Kalle", "Ärenden"); // Tar bort listan efter den skapades.
		// Kommentera in eller ut för att
		// // testa
		...
		// public static void addNewToDoForUser(String username, String nameOfList,
		// String nameOfToDo, long timeOfToDo) {
		// for (User user : userlist.getUserList()) {
		// if (user.getUsername().equals(username)) {
		// for (ListOfToDos list : user.getToDoLists()) {
